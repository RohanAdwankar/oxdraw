...
const CONFIGURED_MODE = process.env.NEXT_PUBLIC_OXDRAW_MODE;
const CONFIGURED_API_BASE = process.env.NEXT_PUBLIC_OXDRAW_API;
const MODE: Mode =
...
const API_BASE = CONFIGURED_API_BASE ?? "http://127.0.0.1:5151";
